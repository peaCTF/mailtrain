...
router.post('/update', passport.parseForm, passport.csrfProtection, (req, res) => {
    ...
    ['smtp_log', 'smtp_self_signed', 'smtp_disable_auth', 'verp_use', 'disable_wysiwyg', 'disable_confirmations', 'enable_recaptcha'].forEach(key => {
